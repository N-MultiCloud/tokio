# Tokio: tests-integration/src/bin

## Purpose

Small binaries used by integration tests, often for process, signal, or subprocess behavior.
...
- Workspace root: `../../..`
- This directory: `tests-integration/src/bin/`

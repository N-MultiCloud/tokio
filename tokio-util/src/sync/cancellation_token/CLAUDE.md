# Tokio: tokio-util/src/sync/cancellation_token

## Purpose

CancellationToken implementation details, waiters, tree nodes, and cancellation propagation.
...
- Workspace root: `../../../..`
- This directory: `tokio-util/src/sync/cancellation_token/`

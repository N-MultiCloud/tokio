...
Fuzzing harness configuration for the main tokio crate. Use it for parser, codec, I/O, or scheduler edge cases where randomized exploration is valuable.

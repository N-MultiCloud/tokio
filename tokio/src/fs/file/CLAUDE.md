# Tokio: tokio/src/fs/file

## Purpose

Implementation details for tokio::fs::File, including async read/write state, blocking-pool handoff, and flush/shutdown behavior.
...
- Workspace root: `../../../..`
- This directory: `tokio/src/fs/file/`

# Tokio: tokio/src/fs/open_options

## Purpose

Builder implementation for asynchronous file open options. Mirrors std::fs::OpenOptions while routing open work through Tokio.
...
- Workspace root: `../../../..`
- This directory: `tokio/src/fs/open_options/`

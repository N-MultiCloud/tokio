# Tokio: tokio/src/runtime/tests/loom_multi_thread

## Purpose

Loom tests for the multi-thread scheduler and cross-thread task behavior.
...
- Workspace root: `../../../../..`
- This directory: `tokio/src/runtime/tests/loom_multi_thread/`

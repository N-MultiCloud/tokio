# Tokio: tokio/src/runtime/blocking

## Purpose

Blocking pool implementation for spawn_blocking and async APIs that must delegate blocking OS calls. Tune carefully because this protects core async worker threads.
...
- Workspace root: `../../../..`
- This directory: `tokio/src/runtime/blocking/`

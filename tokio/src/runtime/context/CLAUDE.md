# Tokio: tokio/src/runtime/context

## Purpose

Thread-local runtime context. This is how tokio::spawn, Handle::current, drivers, and task-local state find the active runtime.
...
- Workspace root: `../../../..`
- This directory: `tokio/src/runtime/context/`

# Tokio: tokio/src/runtime/task

## Purpose

Task harness internals: raw task allocation, state transitions, wakers, join handles, cancellation, scheduling, and tracing hooks.
...
- Workspace root: `../../../..`
- This directory: `tokio/src/runtime/task/`

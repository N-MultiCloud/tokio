# Tokio: tokio/src/runtime/scheduler/current_thread

## Purpose

Single-threaded scheduler. It runs tasks only while block_on or LocalSet drives the runtime.
...
- Workspace root: `../../../../..`
- This directory: `tokio/src/runtime/scheduler/current_thread/`

# Tokio: tokio/src/runtime/scheduler/inject

## Purpose

Global injection queue used to hand tasks into a scheduler from external threads or remote handles.
...
- Workspace root: `../../../../..`
- This directory: `tokio/src/runtime/scheduler/inject/`

# Tokio: tokio/src/runtime/scheduler/multi_thread/handle

## Purpose

Handle-side logic for the multi-thread scheduler, including remote spawning and worker coordination hooks.
...
- Workspace root: `../../../../../..`
- This directory: `tokio/src/runtime/scheduler/multi_thread/handle/`

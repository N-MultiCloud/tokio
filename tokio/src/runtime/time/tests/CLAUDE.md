# Tokio: tokio/src/runtime/time/tests

## Purpose

Timer-driver tests for scheduling, cancellation, pause/advance, and edge cases.
...
- Workspace root: `../../../../..`
- This directory: `tokio/src/runtime/time/tests/`

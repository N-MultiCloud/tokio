# Tokio: tokio/src/task/coop

## Purpose

Cooperative scheduling budget implementation. This prevents long-running futures from starving the runtime.
...
- Workspace root: `../../../..`
- This directory: `tokio/src/task/coop/`

# Tokio: tokio/src/signal

## Purpose

Public async signal handling APIs. Bridges OS signal mechanisms into futures and streams through the runtime signal driver.
...
- Workspace root: `../../..`
- This directory: `tokio/src/signal/`

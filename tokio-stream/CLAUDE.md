...
Companion crate for Stream adapters and wrappers around Tokio primitives. It bridges Tokio channels, listeners, signals, and interval types into futures_core::Stream.

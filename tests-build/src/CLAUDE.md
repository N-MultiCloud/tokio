# Tokio: tests-build/src

## Purpose

Small support library for tests-build. Keep helpers here minimal so compile tests exercise Tokio's public API rather than local abstractions.
...
- Workspace root: `../..`
- This directory: `tests-build/src/`

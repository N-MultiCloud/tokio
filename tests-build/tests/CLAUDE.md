# Tokio: tests-build/tests

## Purpose

Top-level integration tests for build-time behavior. The pass and fail subdirectories hold trybuild-style fixtures.
...
- Workspace root: `../..`
- This directory: `tests-build/tests/`

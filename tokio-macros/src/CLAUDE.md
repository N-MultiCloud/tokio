# Tokio: tokio-macros/src

## Purpose

Implementation of Tokio procedural macros, including entry-point parsing, runtime flavor selection, and generated async test/main wrappers.
...
- Workspace root: `../..`
- This directory: `tokio-macros/src/`

# Tokio: .github/ISSUE_TEMPLATE

## Purpose

GitHub issue forms for bug reports and feature requests. These files shape contributor intake before maintainers triage runtime, I/O, docs, or ecosystem issues.
...
- Workspace root: `../..`
- This directory: `.github/ISSUE_TEMPLATE/`

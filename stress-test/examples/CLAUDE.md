# Tokio: stress-test/examples

## Purpose

Standalone stress-test scenarios. These are entry points for manual or scripted stress runs.
...
- Workspace root: `../..`
- This directory: `stress-test/examples/`
